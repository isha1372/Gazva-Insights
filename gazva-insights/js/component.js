...
(function () {
  ...
  const LOGO_SVG = `
    <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <rect width="40" height="40" rx="10" fill="#1F6E4D"/>
      <path d="M12 27V14.5L20 10l8 4.5V27" stroke="#FAFAF8" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M16 27v-7.5h8V27" stroke="#C8973A" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>`;
    ...
    footer.innerHTML = `
      <div class="footer__top">
        ...
        <div>
          ...
          <ul class="footer__links">
            ${FOOTER_QUICKLINKS.map((l) => `<li><a href="${base}${l.href}">${l.label}</a></li>`).join("")}
      ...
      <div class="footer__bottom">
        <div class="footer__bottom-inner">
          <span>&copy; <span id="footerYear">2026</span> Gazva Insights. All rights reserved.</span>
          <span>Powered by Gazva Media</span>
        </div>
      </div>`;
    return footer;
  }
